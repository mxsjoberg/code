...
result = optimize(f_1, create_swarm(x_0=[5], n_par=15), bounds=[(0, 4)], max_iterations=50)
# print(result)
# (-14.91, [2.4])
...
result = optimize(f_2, create_swarm(x_0=[5, 5], n_par=15), bounds=None, max_iterations=50)
# print(result)
# (-9.33, [0.67, -1.67])
